...
**数据源开关 (Source Switch)**: news.json `sources` 段的四个布尔开关（zhihu/guokr/bilibili/rss，默认全开；rss 为 ADR-0121 新增），决定数据源守护抓哪些源；插件侧唯一写点 = 剪藏本设置弹窗「数据源」组。
