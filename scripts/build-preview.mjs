...
// 不回退双轨。
export const PREVIEW_DOMAINS = ["belongings", "bookshelf", "cinema", "clipbook", "home", "memo", "password-vault", "review", "secondbrain", "settings-panel"];
...
export const BEHAVIOR_DOMAINS = ["belongings", "bookshelf", "cinema", "clipbook", "favorites", "home", "knowledge", "memo", "password-vault", "review", "secondbrain", "settings-panel"];
