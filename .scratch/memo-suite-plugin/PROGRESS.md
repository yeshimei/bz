...
最后更新：2026-08-08（ticket 24 设置归属模型），752 测试（1 既有失败 flash vector-store 增量刷新 + 1 并行 flaky belongings extra 超时，均与本次无关）。仓库 `E:/Obsidian/1`，构建产物直出 `E:/Obsidian/叫我包仔/.obsidian/plugins/bz/`。
