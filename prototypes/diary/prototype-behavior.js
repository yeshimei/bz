/* 源指纹 3a8f023530ba9aa6 · 仓内输入 78 个（校验见 tests/preview-freshness.test.ts） */
...
var BZW_diary = (() => {
  ...
  var LOCK_KIND_META, lastVisitedAsset, _UIManager, UIManager, _EncryptAppController, EncryptAppController;
  var init_ui2 = __esm({
    "src/encrypt/ui.ts"() {
      init_fake_obsidian();
      init_notice();
...
![[${String(cover).trim()}]]`;
  ...
  var ATTACHMENT_MAX_BYTES = 64 * 1024 * 1024;
