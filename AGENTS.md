...
| smartcat 小橘（桌面宠物猫 + 笔记 AI 陪伴：气泡/聊天/心情/分层记忆/动画/语音/书评；AI 走 bz core/ai，数据单 json，样式域内 styles.css） | smartcat.json（config/mood/personalityGrowth/emotionalMemory/timeEmotion/editingData/memory 四层） |
