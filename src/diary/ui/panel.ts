    ...
    groups: [
      {
        ...
        rows: [
          { type: 'choiceCards', name: '布局', binding: { key: 'diarySkin' }, options: [{ value: 'default', label: '纸页', prevClass: 'bz-sp-prev-panel' }] },
          { type: 'choiceCards', name: '主题', binding: { key: 'diarySkinTheme' }, layoutKey: 'diarySkin', options: [{ value: 'ivory', label: '象牙白', layout: 'default', prevClass: 'bz-sp-prev-ivory' }] },
        ],
      },
      {
