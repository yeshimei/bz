    ...
    groups: [
      {
        ...
        rows: [
          { type: 'choiceCards', name: '布局', binding: { key: 'literatureSkin' }, options: [{ value: 'default', label: '索引卡', prevClass: 'bz-sp-prev-panel' }] },
          { type: 'choiceCards', name: '主题', binding: { key: 'literatureSkinTheme' }, layoutKey: 'literatureSkin', options: [{ value: 'manila', label: '牛皮纸', layout: 'default', prevClass: 'bz-sp-prev-manila' }] },
        ],
      },
      {
