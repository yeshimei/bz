/* 构建产物（勿手改）：node scripts/build-preview.mjs — src/favorites/fake-sim.ts → window.BZW_favorites（行为单源预览包，issue 245/ADR-0106） */
var BZW_favorites = (() => {
  ...
  // src/favorites/fake/fake-obsidian.ts
  var Platform = {
