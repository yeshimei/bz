    ...
    groups: [
      {
        ...
        name: '外观',
        rows: [
          { type: 'choiceCards', name: '布局', binding: { key: 'favoritesSkin' }, options: [{ value: 'default', label: '标签工作台', prevClass: 'bz-sp-prev-panel' }] },
          { type: 'choiceCards', name: '主题', binding: { key: 'favoritesSkinTheme' }, layoutKey: 'favoritesSkin', options: [{ value: 'linen', label: '亚麻', layout: 'default', prevClass: 'bz-sp-prev-linen' }] },
        ],
      },
