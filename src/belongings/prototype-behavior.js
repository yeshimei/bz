/* 构建产物（勿手改）：node scripts/build-preview.mjs — src/belongings/fake-sim.ts → window.BZW_belongings（行为单源预览包，issue 245/ADR-0106） */
var BZW_belongings = (() => {
  ...
  // src/belongings/fake/fake-obsidian.ts
  var Platform = {
