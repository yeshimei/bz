/* 构建产物（勿手改）：node scripts/build-preview.mjs — src/review/fake-sim.ts → window.BZW_review（行为单源预览包，issue 245/ADR-0106） */
var BZW_review = (() => {
  ...
  // src/review/fake/fake-obsidian.ts
