 ...
 *
 * 取值原则：命令 id 与图标名对齐 src/core/domain-icons.ts（域图标单一事实源，enh-sweep-a 收敛；icon 与入口页磁贴一致）；
...
export const DOMAINS: HomeDomain[] = [
  ...
  { id: 'recap', commandId: 'bz-recap-today', name: '今日回顾', sub: '今天的痕迹一条线', icon: 'calendar-heart' },
  ...
  { id: 'literature', commandId: 'bz-literature-open', name: '文献盒', sub: '文献笔记与录入', icon: 'list-video' },
  ...
  { id: 'reading-report', commandId: 'bz-reading-report-open', name: '阅读报告', sub: '阅读数据分析', icon: 'bar-chart-3' },
