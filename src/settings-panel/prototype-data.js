  ...
  const DOMAINS = {
    ...
    appearance: { name: '设置', icon: 'palette', desc: '设置面板的布局与主题', groups: [
      { icon: 'palette', name: '外观', rows: [
        ...
        { t: 'choiceCards', n: '面板布局', k: 'settingsPanelLayout', kind: 'layout', opts: [
          { v: 'jingwei', l: '经纬', prev: { mode: 'system' }, theme: 'chenhun' },
        ] },
        // 主题与布局一一对应：随布局自动切换（此处卡片同步高亮当前配套主题）
        { t: 'choiceCards', n: '面板主题', k: 'settingsPanelSkin', kind: 'skin', opts: [
    ...
    diary: { name: '日记本', icon: 'notebook-pen', desc: '日记目录、显示与默认视图', groups: [
      ...
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'diarySkin', kind: 'layout', opts: [
          { v: 'default', l: '纸页', prev: { mode: 'system' }, theme: 'ivory' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'diarySkinTheme', kind: 'skin', layoutKey: 'diarySkin', opts: [
    ...
    'diary-wall': { name: '回忆墙', icon: 'images', desc: '回忆墙媒体视图（只读）', groups: [
      ...
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'diaryWallSkin', kind: 'layout', opts: [
          { v: 'default', l: '媒体墙', prev: { mode: 'system' }, theme: 'gallery' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'diaryWallSkinTheme', kind: 'skin', layoutKey: 'diaryWallSkin', opts: [
    ...
    todo: { name: '待办', icon: 'check-square', desc: '待办工作台与提醒（捕获入口落点）', groups: [
      ...
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'todoSkin', kind: 'todo', opts: [
        ...
        { t: 'choiceCards', n: '面板主题', k: 'todoSkinTheme', kind: 'skin', layoutKey: 'todoSkin', opts: [
    ...
    belongings: { name: '归物本', icon: 'package', desc: '物品登记与查找', groups: [
      ...
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'belSkin', kind: 'poster', opts: [
          { v: 'poster', l: '大字报', prev: { bg: '#f5f2ec', ink: '#171512', ac: '#e8481f' }, theme: 'warmwhite' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'belSkinTheme', kind: 'skin', layoutKey: 'belSkin', opts: [
    ...
    clipbook: { name: '剪藏本', icon: 'scissors', desc: '未读流与剪藏笔记', groups: [
      // 外观组（issue 246 占位单卡）
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'clipbookSkin', kind: 'layout', opts: [
          { v: 'default', l: '编辑部', prev: { mode: 'system' }, theme: 'newsprint' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'clipbookSkinTheme', kind: 'skin', layoutKey: 'clipbookSkin', opts: [
    ...
    favorites: { name: '收藏本', icon: 'star', desc: '收藏条目', groups: [
      // 外观组（issue 246 占位单卡）；桌面零设置标记随外观组摘除
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'favoritesSkin', kind: 'layout', opts: [
          { v: 'default', l: '标签工作台', prev: { mode: 'system' }, theme: 'linen' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'favoritesSkinTheme', kind: 'skin', layoutKey: 'favoritesSkin', opts: [
    ...
    cinema: { name: '影院', icon: 'clapperboard', desc: '影视目录与海报', groups: [
      ...
      // 非法值域内回落午夜场）；主题行占位
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'cinemaStyle', kind: 'layout', opts: [
          { v: 'midnight', l: '午夜场', prev: { mode: 'system' }, theme: 'nightfall' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'cinemaSkinTheme', kind: 'skin', layoutKey: 'cinemaStyle', opts: [
    ...
    bookshelf: { name: '书库', icon: 'book-open', desc: '藏书封面墙', groups: [
      ...
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板主题', k: 'bookshelfSkin', kind: 'shelf', opts: [
    ...
    review: { name: '复习计划', icon: 'repeat-2', desc: '间隔重复与做题', groups: [
      // 外观组（issue 246 占位单卡）
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'reviewSkin', kind: 'layout', opts: [
          { v: 'default', l: '三区队列', prev: { mode: 'system' }, theme: 'sage' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'reviewSkinTheme', kind: 'skin', layoutKey: 'reviewSkin', opts: [
    ...
    secondbrain: { name: '第二大脑', icon: 'brain', desc: '嵌入检索与对话', groups: [
      // 外观组（issue 246 占位单卡）
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'secondbrainSkin', kind: 'layout', opts: [
          { v: 'default', l: '对话', prev: { mode: 'system' }, theme: 'graphite' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'secondbrainSkinTheme', kind: 'skin', layoutKey: 'secondbrainSkin', opts: [
    ...
    literature: { name: '文献盒', icon: 'list-video', desc: '文献笔记与术语录入', groups: [
      // 外观组（issue 246 占位单卡）
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'literatureSkin', kind: 'layout', opts: [
          { v: 'default', l: '索引卡', prev: { mode: 'system' }, theme: 'manila' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'literatureSkinTheme', kind: 'skin', layoutKey: 'literatureSkin', opts: [
    ...
    pomodoro: { name: '番茄钟', icon: 'timer', desc: '专注计时与休息', groups: [
      // 外观组（issue 246 占位单卡）
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'pomodoroSkin', kind: 'layout', opts: [
          { v: 'default', l: '计时盘', prev: { mode: 'system' }, theme: 'tomato' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'pomodoroSkinTheme', kind: 'skin', layoutKey: 'pomodoroSkin', opts: [
    ...
    encrypt: { name: '保险库', icon: 'lock', desc: '密码、加密笔记与加密日记', groups: [
      // 外观组（issue 246 占位单卡）
      { icon: 'palette', name: '外观', rows: [
        { t: 'choiceCards', n: '面板布局', k: 'encryptSkin', kind: 'layout', opts: [
          { v: 'default', l: '三栏', prev: { mode: 'system' }, theme: 'steel' },
        ] },
        { t: 'choiceCards', n: '面板主题', k: 'encryptSkinTheme', kind: 'skin', layoutKey: 'encryptSkin', opts: [
