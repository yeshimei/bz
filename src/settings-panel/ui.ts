...
export const DOMAINS: DomainDef[] = [
  ...
  { id: 'memo', name: '备忘录', icon: DOMAIN_ICONS.memo, desc: '提醒与到期行为', schemaLoader: schemaLoaders.memo },
  { id: 'todo', name: '待办', icon: DOMAIN_ICONS.todo, desc: '待办事项工作台', schemaLoader: schemaLoaders.todo },
