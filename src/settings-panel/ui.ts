...
const DOMAINS: DomainDef[] = [
  ...
  { id: 'memo', name: '备忘录', icon: 'sticky-note', desc: '场景与显示行为（提醒已并入待办）', schemaLoader: schemaLoaders.memo },
  { id: 'todo', name: '待办', icon: 'check-square', desc: '待办工作台与提醒（捕获入口落点）', schemaLoader: schemaLoaders.todo },
